...
function SimpleCard({ dummy }) {
    ...
    const avatarType = (type) => {
        // replaced Switch Statement by an object, that was inspired by:  https://stackoverflow.com/questions/6114210/is-returning-out-of-a-switch-statement-considered-a-better-practice-than-using-b
        return (
            {
